...
| Heuristic | Decision it helps with | Status |
|-----------|------------------------|--------|
| [dialog-stepper-fullscreen-drawer](heuristics/dialog-stepper-fullscreen-drawer.md) | Which container pattern fits a task | Stable |
| [disable-vs-hide](heuristics/disable-vs-hide.md) | When to disable an action vs remove it | Stable |
...
3. Update the status column in the table above if a TODO graduates to stable, or vice versa.
4. If the heuristic introduces a new judgment call the audit should flag, add a sentence in `design-audit/references/rubric.md` (Category 6) pointing to the file.
